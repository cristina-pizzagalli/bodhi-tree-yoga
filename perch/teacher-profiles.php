...
<html lang='en'>
  <head>
    <title>
      Bodhi Tree Studio - Teacher Profiles
    </title>
    <meta charset='utf-8'>
    ...
    <div id='wrap'>
      ...
      <div id='main'>
        <div class='content-about'>
          <div class='about-teachers-wrapper'>
            <h1>
              Teacher Profiles
            </h1>
            <ul class='bxslider-teachers'><?php perch_content('Teachers-Listing') ?></ul>
          </div>
          <div id='bx-pager'><?php perch_content_custom('Teachers-Listing', array('template' => 'teacher-profile-nav.html')) ?></div>
        </div>
      </div>
    </div>
    <div id='footer'>
